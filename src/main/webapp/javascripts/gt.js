...
(function( $, undefined ) {
    ...
    var drawServers = function(servers){		
        ...
        regServers.append($("<h3/>",{
            text: "Registered Servers"
        }));
        var regServersForm = $("<form/>",{
            id: "regServersForm"
        });
        ...
        for(var i = 0; i < servers.length; i++){
            ...
            li.append($("<input/>", {
                type:"checkbox", 
                name:"server", 
                value:servers[i].server +":"+servers[i].port
                }));
    ...
    var drawCurrentServers = function(servers){
        ...
        currServers.append($("<h3/>",{
            text: "Selected Servers for Search"
        }));
        var currServersForm = $("<form/>",{
            id: "currServersForm"
        });
    ...
    var drawContentDistributors = function(servers){
        ...
        contentdist.append($("<h3/>",{
            text: "Content Distributors"
        }));
        var contentdistForm = $("<form/>",{
            id: "contentdistForm"
        });
    ...
    var drawCurrentViews = function(){
        ...
        $.getJSON(appname+"/flow/search/GetAvailableViews", function(json){
            ...
            views.append($("<h3/>",{
                text: "Views for current servers"
            }));
            if(json.length <= 0){
        ...
        button.click(function(){
            ...
            $.ajax({
                ...
                beforeSend: function(){
                    ...
                    $("#modal").append($("<br/>"));
                    $("#modal").append($("<img/>",{
                        src: appname+"/images/loading.gif"
                        }));
                    $("#modal").modal({
                        overlay:100,
                        overlayCss: {
